...
public class Invoice {
    ...
    public void setProductType(String itemType) {
    ...
    public boolean equals(Object o) {
        ...
        return getId() == invoice.getId() &&
                ...
                Objects.equals(getProductType(), invoice.getProductType()) &&
    ...
    public int hashCode() {
        return Objects.hash(getId(), getName(), getStreet(), getCity(), getState(), getZipcode(),
                getProductType(), getItemId(), getUnitPrice(), getQuantity(), getSubtotal(), getTax(),
